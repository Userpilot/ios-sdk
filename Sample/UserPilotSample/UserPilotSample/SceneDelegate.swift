...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene,
        ...
        if let windowScene = scene as? UIWindowScene {
            ...
            let navigationController = BaseNavigationController(rootViewController: MainViewController.newInstance())
            FlowRoutingManager.setup(navigationController: navigationController)
