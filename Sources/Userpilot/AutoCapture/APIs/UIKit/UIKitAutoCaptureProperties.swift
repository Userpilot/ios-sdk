...
public extension UIResponder {
    ...
    /// ```
    @objc
    public var userpilotIgnoreInteractions: Bool {
        get {
    ...
    @objc
    public var userpilotIgnoreInnerHierarchy: Bool {
        get {
    ...
    /// ```
    @objc
    public var userpilotRedactText: Bool {
        get {
    ...
    /// ```
    @objc
    public var userpilotRedactAccessibilityLabel: Bool {
        get {
